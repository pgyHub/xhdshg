...
const 美发 = () => (
  <IndustryPage
    ...
    heroMedia={{ src: H.hero, alt: '潮流发型主视觉（已裁切底部字标）', kind: 'image', imagePosition: 'center 22%' }}
    venueSectionTitle="环境与作品区"
    venueSectionSubtitle="下列为已裁切底部字标的造型示意；横滑三图与首图各不相同，可与彩妆、婚摄等模块并存。"
    venueGallery={[
      { src: H.g1, caption: '横滑位一：门店造型咨询与工位氛围', imagePosition: 'center 30%' },
      { src: H.g2, caption: '横滑位二：中长卷发与质感呈现', imagePosition: 'center 38%' },
      { src: H.g3, caption: '横滑位三：短发造型与轮廓线条', imagePosition: 'center 25%' }
    ]}
    ...
    layoutModules={[
      ...
      { title: '项目价格一览', desc: '按剪发、染发、烫发、护理拆分价格模块，便于快速决策。', image: H.l3, imagePosition: 'center 45%' },
      { title: '发质检测流程', desc: '通过步骤卡说明“检测-建议-执行-护理”服务闭环。', image: H.l4, imagePosition: 'center 26%' },
      { title: '顾客案例前后对比', desc: '占位展示改造前后效果，后续替换真实图片。', image: H.l5, imagePosition: 'center 28%' },
      { title: '预约与到店指引', desc: '预留门店位置、营业时间、预约入口等实用信息。', image: H.l6, imagePosition: 'center 22%' }
    ]}
    marketStats={[
