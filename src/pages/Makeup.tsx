...
const 彩妆 = () => (
  <IndustryPage
    ...
    heroMedia={{ src: M.hero, alt: '彩妆主视觉（已裁切底部字标）', kind: 'image', imagePosition: 'center 28%' }}
    venueSectionTitle="陈列与体验区"
    venueSectionSubtitle="下列为已裁切字标的妆面/创意示意；横滑三图与首图各不相同，可与美发、婚摄等模块并存。"
    venueGallery={[
      { src: M.g1, caption: '横滑位一：创意妆面与花艺氛围（品牌故事/主题季）', imagePosition: 'center 36%' },
      { src: M.g2, caption: '横滑位二：礼服妆面与肤质光感（底妆与高光说明）', imagePosition: 'center 24%' },
      { src: M.g3, caption: '横滑位三：眼妆细节与线条（眼妆 SKU 或技法入口）', imagePosition: 'center 30%' }
    ]}
    ...
    layoutModules={[
      ...
      { title: '妆容灵感专区', desc: '以“通勤妆、约会妆、晚宴妆”卡片展示，当前为示例文案。', image: M.l3, imagePosition: 'center 20%' },
      { title: '口碑评价模块', desc: '展示虚拟评分、体验反馈与用户标签，后续可接评论数据。', image: M.l4, imagePosition: 'center 22%' },
      { title: '化妆服务套餐区', desc: '结合上门妆造/试妆/跟妆服务形成套餐卡片，支持后续改价。', image: M.l5, imagePosition: 'center 40%' },
      { title: '品牌故事与会员权益', desc: '预留品牌理念、会员积分、生日礼等信息展示位。', image: M.l6, imagePosition: 'center 44%' }
    ]}
    marketStats={[
