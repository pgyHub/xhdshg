...
const Footer = () => {
  return (
    <footer className="site-footer">
      ...
      {/* 帮助中心弹窗内容 */}
      <div className="footer-help-content" id="help-guide">
      ...
      {/* 常见问题弹窗内容 */}
      <div className="footer-help-content" id="faq">
        <div className="help-modal">
          <h3>常见问题</h3>
          <div className="help-content">
      ...
      {/* 联系客服弹窗内容 */}
      <div className="footer-help-content" id="contact">
        <div className="help-modal">
          <h3>联系客服</h3>
      ...
      {/* 投诉建议弹窗内容 */}
      <div className="footer-help-content" id="feedback">
        <div className="help-modal">
          <h3>投诉建议</h3>
          <div className="help-content">
      ...
      {/* 关于我们弹窗内容 */}
      <div className="footer-help-content" id="about">
        <div className="help-modal">
          <h3>公司简介</h3>
      ...
      {/* 加入我们弹窗内容 */}
      <div className="footer-help-content" id="join">
        <div className="help-modal">
          <h3>加入我们</h3>
      ...
      {/* 商务合作弹窗内容 */}
      <div className="footer-help-content" id="business">
        <div className="help-modal">
          <h3>商务合作</h3>
      ...
      {/* 资质荣誉弹窗内容 */}
      <div className="footer-help-content" id="honor">
        <div className="help-modal">
          <h3>资质荣誉</h3>
